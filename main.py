...
"""
    ...
    readme_content += "\n## About\n\n"
    readme_content += "This list is automatically generated by scraping release tags from the [Positron GitHub repository](https://github.com/posit-dev/positron/tags) and checking for available installers on the Positron CDN.\n"
    readme_content += "\n## Data persistence\n\n"
    readme_content += (
        "Daily build metadata is cached in `data/dailies.csv`, allowing the script to track which versions "
        "have already been checked and limit the history to the 30 most recent dailies for quick reference.\n"
    )
